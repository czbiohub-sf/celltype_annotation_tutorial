# This script is from Alec - exCellxgene repo: https://github.com/czbiohub/excellxgene/blob/main/backend/common/colors.py
# This script is for converting the color schema in scanpy to cellxgene style. This will be useful for generating pltos that are in consistent style with excellxgene.
import re
